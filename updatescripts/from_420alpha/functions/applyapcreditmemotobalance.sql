-- DROP FUNCTION applyapcreditmemotobalance(integer);

CREATE OR REPLACE FUNCTION applyapcreditmemotobalance(integer)
  RETURNS integer AS
$BODY$
...
--  DA Aug 2013 Change to use Voucher AP Date
  FOR _r IN SELECT target.apopen_id AS apopenid,
                   currToCurr(target.apopen_curr_id,source.apopen_curr_id, 
                     ...
                     target.apopen_docdate) AS balance
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION applyapcreditmemotobalance(integer)
  OWNER TO admin;
